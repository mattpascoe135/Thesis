...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("146d8582-8b79-4fa5-932f-5cb7e7650f94"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 OutputReg (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam OutputReg.Bit0Mode = 0;
    defparam OutputReg.Bit1Mode = 0;
    defparam OutputReg.Bit2Mode = 0;
    defparam OutputReg.Bit3Mode = 0;
    defparam OutputReg.Bit4Mode = 0;
    defparam OutputReg.Bit5Mode = 0;
    defparam OutputReg.Bit6Mode = 0;
    defparam OutputReg.Bit7Mode = 0;
	...
	wire [0:0] tmpIO_0__SDPT_0_net;
	wire [0:0] tmpINTERRUPT_0__SDPT_0_net;
	electrical [0:0] tmpSIOVREF__SDPT_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		SDPT_0
		 (.oe(tmpOE__SDPT_0_net),
		  .y({Net_257}),
		  .fb({tmpFB_0__SDPT_0_net[0:0]}),
		  .io({tmpIO_0__SDPT_0_net[0:0]}),
		  .siovref(tmpSIOVREF__SDPT_0_net),
		  .interrupt({tmpINTERRUPT_0__SDPT_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SDPT_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SPDT_1_net;
	wire [0:0] tmpFB_0__SPDT_1_net;
	wire [0:0] tmpIO_0__SPDT_1_net;
	wire [0:0] tmpINTERRUPT_0__SPDT_1_net;
	electrical [0:0] tmpSIOVREF__SPDT_1_net;

	cy_psoc3_pins_v1_10
		#(.id("11095f58-2eb9-4897-9889-8c20d99cd48e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SPDT_1
		 (.oe(tmpOE__SPDT_1_net),
		  .y({Net_263}),
		  .fb({tmpFB_0__SPDT_1_net[0:0]}),
		  .io({tmpIO_0__SPDT_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SPDT_1_net),
		  .interrupt({tmpINTERRUPT_0__SPDT_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPDT_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SP8T_0_net;
	wire [0:0] tmpFB_0__SP8T_0_net;
	wire [0:0] tmpIO_0__SP8T_0_net;
	wire [0:0] tmpINTERRUPT_0__SP8T_0_net;
	electrical [0:0] tmpSIOVREF__SP8T_0_net;

	cy_psoc3_pins_v1_10
		#(.id("31ef987a-e4bd-4d70-9c14-a8376cf63391"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SP8T_0
		 (.oe(tmpOE__SP8T_0_net),
		  .y({Net_259}),
		  .fb({tmpFB_0__SP8T_0_net[0:0]}),
		  .io({tmpIO_0__SP8T_0_net[0:0]}),
		  .siovref(tmpSIOVREF__SP8T_0_net),
		  .interrupt({tmpINTERRUPT_0__SP8T_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SP8T_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SP8T_1_net;
	wire [0:0] tmpFB_0__SP8T_1_net;
	wire [0:0] tmpIO_0__SP8T_1_net;
	wire [0:0] tmpINTERRUPT_0__SP8T_1_net;
	electrical [0:0] tmpSIOVREF__SP8T_1_net;

	cy_psoc3_pins_v1_10
		#(.id("f1213997-2a10-44f3-a22d-5ddeba08335e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SP8T_1
		 (.oe(tmpOE__SP8T_1_net),
		  .y({Net_260}),
		  .fb({tmpFB_0__SP8T_1_net[0:0]}),
		  .io({tmpIO_0__SP8T_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SP8T_1_net),
		  .interrupt({tmpINTERRUPT_0__SP8T_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SP8T_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_257 = Net_245 & Net_244;


    assign Net_259 = Net_245 & Net_253;


    assign Net_260 = Net_245 & Net_249;


    assign Net_261 = Net_245 & Net_251;


    assign Net_263 = ~Net_257;

	wire [0:0] tmpOE__SP8T_2_net;
	wire [0:0] tmpFB_0__SP8T_2_net;
	wire [0:0] tmpIO_0__SP8T_2_net;
	wire [0:0] tmpINTERRUPT_0__SP8T_2_net;
	electrical [0:0] tmpSIOVREF__SP8T_2_net;

	cy_psoc3_pins_v1_10
		#(.id("da4873f5-9510-47ff-8085-320f76910c2a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SP8T_2
		 (.oe(tmpOE__SP8T_2_net),
		  .y({Net_261}),
		  .fb({tmpFB_0__SP8T_2_net[0:0]}),
		  .io({tmpIO_0__SP8T_2_net[0:0]}),
		  .siovref(tmpSIOVREF__SP8T_2_net),
		  .interrupt({tmpINTERRUPT_0__SP8T_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
